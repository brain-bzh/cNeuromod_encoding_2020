python ../model_training.py -s 03 -d friends --trainData s01 s02 s03 --evalData s04 --scale auditory_Voxels --lr 1e-4 --wd 1e-2 --patience 20 --delta 0.1 --bs 70 --ks 5 --lrScheduler --decoupledWD --gpu --wandb
